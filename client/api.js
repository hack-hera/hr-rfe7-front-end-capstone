...
const api = {
  ...
  getProducts: function (params = {}) {
    ...
    return axios.get(host + `/products?page=${page}&count=${count}`, headers)
  ...
  getProduct: function (params = {}) {
    ...
    return axios.get(host + '/products/' + product_id, headers)
      .then(res => Promise.resolve(res.data))
      .catch(err => Promise.reject(new Error(err)));
  },
  ...
  ******************************************************************************/
  ...
  getReviewMeta: function (params = {}) {
    ...
    return axios.get(host + '/reviews/meta?product_id=' + product_id, headers)
      .then(res => Promise.resolve(res.data))
      .catch(err => Promise.reject(new Error(err)));
  },
  ...
  markReviewAsHelpful: function (params = {}) {
    ...
    if (!review_id) { return Promise.reject(new Error('params must contain {review_id}')); }
  ...
  getAnswers: function (params = {}) {
    ...
    if (!question_id) { return Promise.reject(new Error('must provide a question_id')); }
  ...
  addAnswer: function (params = {}) {
    ...
    if (!question_id || !body || !name || !email || !photos || Object.keys(params).length !== 5) {
      return Promise.reject(new Error('params must contain only {question_id, body, name, email, photos}'));
    }
  ...
  markQuestionAsHelpful: function (params = {}) {
    const { question_id } = params;
    if (!question_id) { return Promise.reject(new Error('params must contain {question_id}')); }
